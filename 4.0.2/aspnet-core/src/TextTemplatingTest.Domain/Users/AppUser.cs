...
namespace TextTemplatingTest.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update TextTemplatingTestDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update TextTemplatingTestEfCoreEntityExtensionMappings to extend the IdentityUser entity
